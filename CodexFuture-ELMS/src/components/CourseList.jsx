...
const Courses = () => {
  ...
  const default_courses = [
      ...
      modules: [
        {
          ...
          content: "Learn the basics of web markup and styling",
          order: 1,
        },
        {
        ...
        },
        {
          ...
          content: "Build interactive user interfaces",
          order: 3,
        },
        {
    ...
    },
    {
      ...
      description:
        "Complete MongoDB, Express, React, Node.js development course",
      category: "Web Development",
      modules: [
        {
          title: "MongoDB Fundamentals",
          content: "Database design and operations",
          order: 1,
        },
        {
        ...
        },
        {
          ...
          content: "State management and hooks",
          order: 3,
        },
        {
          title: "Node.js Best Practices",
          content: "Server optimization and deployment",
          order: 4,
        },
      ],
      price: 399.99,
    },
    {
      ...
      modules: [
        ...
        },
        {
          ...
          content: "Advanced Excel techniques",
          order: 2,
        },
        {
          title: "SQL for Data Analysis",
          content: "Database querying",
          order: 3,
        },
        {
        ...
        },
        {
          ...
          content: "Creating charts and dashboards",
          order: 5,
        },
      ],
      price: 249.99,
    },
    {
      ...
      title: "Data Science",
      description:
        "Complete data science pipeline from collection to machine learning",
      category: "Data Science",
      modules: [
        {
    ...
    },
    {
      ...
      modules: [
        ...
        },
        {
          ...
          content: "Dependency injection and Spring Boot",
          order: 2,
        },
        {
          title: "Database Integration",
          content: "JPA and Hibernate",
          order: 3,
        },
        { title: "REST APIs", content: "Building web services", order: 4 },
        {
          title: "Testing & Deployment",
          content: "JUnit testing and deployment strategies",
          order: 5,
        },
      ],
      price: 349.99,
    },
    {
      ...
      description:
        "Modern Python development for web applications and automation",
      category: "Programming",
      modules: [
        {
        ...
        },
        {
          ...
          content: "Modern async API development",
          order: 3,
        },
        {
          title: "Python Libraries",
          content: "Working with popular libraries",
          order: 4,
        },
        {
          title: "Automation & Scripting",
          content: "Task automation and web scraping",
          order: 5,
        },
      ],
      price: 279.99,
  ...
  const getCourseImage = (title) => {
    const images = {
      "Full Stack Developer":
        "/src/assets/course-icons/Full-Stack-Developers.webp",
      ...
      <div className="max-w-6xl mx-auto">
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
          {filteredCourses.map((course) => (
            <div
              key={course.id}
              className="course-card interactive-hover fade-in-up"
            >
              {/* Course Image*/}
              <div>
                <img
